const data = [
	...
	{
		id: 1,
		origText: "Beh, ano yung nalalaman kong tinatarayan mo kami beh? Famous ka? Tapang ka ah, kakasa ka ba? Ano beh palag square bati lang, ano beh? Beh, hoy bakit ka natatakot e ikaw ang nauna, pumalag ka k*ng**a mo ouch aray ha /sinabunutan; k*ng**a! Aray ah p**a chemsi yung bato! /Pinukpok; oha k*ng**a mo ka ah sakit aray beh, beh tulong Beh, ano yung nalalaman kong tinatarayan mo kami beh? Famous ka? Tapang ka ah, kakasa ka ba? Ano beh palag square bati lang, ano beh? Beh, hoy bakit ka natatakot e ikaw ang nauna, pumalag ka k*ng**a mo ouch aray ha /sinabunutan; k*ng**a! Aray ah p**a chemsi yung bato! /Pinukpok; oha k*ng**a mo ka ah sakit aray beh, beh tulong Beh, ano yung nalalaman kong tinatarayan mo kami beh? Famous ka? Tapang ka ah, kakasa ka ba? Ano beh palag square bati lang, ano beh? Beh, hoy bakit ka natatakot e ikaw ang nauna, pumalag ka k*ng**a mo ouch aray ha /sinabunutan; k*ng**a! Aray ah p**a chemsi yung bato! /Pinukpok; oha k*ng**a mo ka ah sakit aray beh, beh tulong.",
		isFavorite: false,
	},
	{
		id: 2,
	...
	{
		id: 6,
		origText: "Everytime na nasasaktan na kami ng sobra that makes a big turn off sa inyong mga boys. What i mean is yung paulit ulit namin kayong binibigyan ng chance tapos sinasayang lang of course masakit sa side namin yun",
		isFavorite: false,
	},
	{
		id: 7,
	...
	{
		id: 14,
		origText: "palibhasa kasi 🤡⁉️ alam na alam 🧠🧠🧠 mo kung 😭😭👉🏻 paano ako kunin eh 💔😔 isang ngiti mo lang 😎😎😎 wala umiikot ↪️↩️🔂 na ulit yung mundo ko 🌍🌏 ta***na ang talino kong 👩🏻‍🏫👀 tao❔ pero pag dating 👇🏻👇🏻 sa'yo? 👁👁👁 ewan ko 🌀 natatanga ako. 🥺🥺 haha ems",
		isFavorite: false,
	},
	{
		id: 15,
	...
	},
	{
		...
		{
		id: 19,
		origText: `⚠️PUBLIC ADVISORY⚠️ mag iingat po tayo sa pagbili ng mga low quality na christmas light this year, may mga tao po ksi na bigla nalang magbibigay ng liwanag sa buhay natin tapos bigla rin mawawala.`,
		isFavorite: false,
	},
	{
		id: 20,
	...
	{
		id: 59,
		origText: "pwede🙏 ba❓kitang ayain? 😁 saan? 😅 sa 🚶‍♀️ pasyalan 😉 sige😄 ba😉pagkatapos😮 ituloy🙈💚na 🎤sa kasalan 👰🥰 ha?? 🙀😪 baliw🤬 ka😵 ba 🌝🤔 eto😤 naman 🤒hindi 🔥mabiro 👁️😬 parang ✨💥g*g* 😡🤬ka 🤦kasi 🤸‍♀️😜 hehez🧖 halika dito 🥵😋",
		isFavorite: false,
	},
	{
		id: 60,
